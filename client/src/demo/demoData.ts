...
export const DEMO_STALLS: Stall[] = [
  {
    ...
    z: -5,
    items: [
      { id: "brand-pizza-0", name: "피자 예시쿠폰", emoji: "🍕", priceEth: "0.002" },
      { id: "brand-pizza-1", name: "조각피자 예시교환권", emoji: "🍕", priceEth: "0.001" },
    ],
    brand: true,
    theme: "pizza",
  ...
  },
  {
    ...
    z: 5,
    items: [
      { id: "brand-cvs-0", name: "삼각김밥 예시교환권", emoji: "🍙", priceEth: "0.0005" },
      { id: "brand-cvs-1", name: "아이스크림 예시교환권", emoji: "🍦", priceEth: "0.0005" },
    ],
    brand: true,
    theme: "cvs",
    createdAt: 1784315132039,
  },
  {
    ...
    z: -5,
    items: [
      { id: "brand-burger-0", name: "버거세트 예시쿠폰", emoji: "🍔", priceEth: "0.001" },
    ],
    brand: true,
    theme: "burger",
    createdAt: 1784315132039,
  ...
  },
  {
    ...
    items: [
      ...
      { id: "s-d3a73104-1", name: "노리개", emoji: "🎀", priceEth: "0.002" },
    ],
