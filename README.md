...
**온체인 구성** (GIWA Sepolia):
- **GiwaMarket 컨트랙트** [`0x61491fee…1357`](https://sepolia-explorer.giwa.io/address/0x61491fee55e574cd515da6383af0a2a1c1511357)
  — 노점 아이템 온체인 리스팅(가격 체인 강제) + 모든 구매에 Purchased 이벤트 영수증.
  리스팅 없는 노점(봇 등)은 영수증 전용 모드로 폴백. `npm run deploy-market`로 재배포.
...
- [ ] GiwaMarket v2 — 에스크로 보류/분쟁, ERC-1155 상품 전달
- [ ] 실브랜드 기프티콘 API 연동
- [ ] UP.ID 이름표
