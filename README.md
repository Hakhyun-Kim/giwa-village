...
📓 **개발일지**: https://hakhyun-kim.github.io/giwa-village/journal.html —
실제 git 기록(커밋 34개·43시간)으로 되짚는 활동 리듬·코드 성장·프롬프트의 진화
...
scripts/    deploy-village.mjs(배포) · verify-contracts.mjs(소스 검증) ·
            launch-test.mjs(원클릭) · gen-wallets · bridge-deposit · faucet-check · 스모크들
```
